            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about-usImg">
                        <img src="<?php echo get_template_directory_uri() . '/images/7b04e496-274d-4529-ab4b-1ab342a497fe 1.png' ?>" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="swiper myswiper9">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="our-card">
                                        <img src="<?php echo get_template_directory_uri() . '/images/our.png' ?>" class="img-fluid" alt="">
