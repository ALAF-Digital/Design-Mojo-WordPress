        ...
        <div class="col-md-3">
          <div class="footer-contact">
            ...
            <ul>
              ...
              <li class="contact-detail">
                <img src="<?php echo get_template_directory_uri() . '/images/location_on.png'?>" alt="" /><a href="#">1A/59 Fletcher Street, Essendon VIC 3040,
                  Melbourne,
                  Australia</a>
              </li>
              <li class="contact-detail">
                <img src="<?php echo get_template_directory_uri() . '/images/call.png'?>" alt="" /><a class="text-decoration-underline"
                  href="tel:+61 (385) 944 036">+61 (385) 944 036</a>
              </li>
            </ul>
          </div>
        </div>
